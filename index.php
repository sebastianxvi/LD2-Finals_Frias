...
IF($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(empty($username)){
        $Lname_err = "Username is required.";
        $error = true;
    }
  ...
  <div class="container">
    <div class="registration-form">
      <form method="POST">
        ...
        <input type="text" id="username" name="username" class="textbox" placeholder="Enter username here"
          required><br><br>

        <label for="email" class="label">Email</label>
        <input type="text" id="email" name="email" class="textbox" placeholder="Enter email here" required><br><br>

        <label for="password" class="label">Password</label>
        <input type="password" id="password" name="password" class="textbox" placeholder="Enter password here"
          required><br><br>

   <label for="Cpass" class="label">Confirm Password</label>
        <input type="password" id="Cpass" name="Cpass" class="textbox" placeholder="Enter password here"
          required><br><br>
